...
def main(args):
    ...
    derivatives_dir = Path("/targetdata/ADNI2_ANTs_RegistrationSynQuick/")
    ...
    for i, participant in enumerate(participant_list[args.start:args.stop]):
        ...
        t1_image = sourcedata_t1_dir / f"T1_ADNI_{participant_id}_{session_id}.nii.gz"
        flair_image = sourcedata_flair_dir / f"FLAIR_ADNI_{participant_id}_{session_id}.nii.gz"
        parcellation_image = sourcedata_parcellation_dir / f"Parcellation_ADNI_{participant_id}_{session_id}.nii.gz"
        segmentation_image = sourcedata_segmentation_dir / f"Parcellation_ADNI_{participant_id}_{session_id}.nii.gz"
