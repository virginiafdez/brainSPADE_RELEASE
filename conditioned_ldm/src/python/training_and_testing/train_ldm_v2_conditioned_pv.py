...
from condldm_models.ddpm_v2_conditioned import DDPM
from training_functions import train_conditioned_ldm
from condldm_util import log_mlflow, get_training_data_loader_pv_conditioned
...
def parse_args():
    ...
    # Dataset
    parser.add_argument('--lesions', type=str, help="List of lesions considered here (in lowercase)")
...
def main(args):
    ...
    train_loader, val_loader = get_training_data_loader_pv_conditioned(
